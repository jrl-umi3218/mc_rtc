...
You can place your observer projects in there so they are built alongside mc_rtc

## Notes

- After adding a new observer make sure to run CMake in mc_rtc build folder so that the new project is picked up
