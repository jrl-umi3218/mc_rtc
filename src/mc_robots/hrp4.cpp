...
HRP4CommonRobotModule::HRP4CommonRobotModule() : RobotModule(mc_rtc::HRP4_DESCRIPTION_PATH, "hrp4")
{
  rsdf_dir = path + "/rsdf";
  ...
  Eigen::Matrix3d R;
  R << 0, -1, 0, -1, 0, 0, 0, 0, -1; // rpy="3.14159 0 -1.57079"
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("RightHandForceSensor", "r_wrist", sva::PTransformd(R, Eigen::Vector3d(0, 0, -0.04435))));
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("LeftHandForceSensor", "l_wrist", sva::PTransformd(R, Eigen::Vector3d(0, 0, -0.04435))));

  _minimalSelfCollisions = {mc_rbdyn::Collision("torso", "L_SHOULDER_Y_LINK", 0.02, 0.001, 0.),
  ...
  _ref_joint_order = {"R_HIP_Y",      "R_HIP_R",      "R_HIP_P",      "R_KNEE_P",     "R_ANKLE_P",    "R_ANKLE_R",
                      "L_HIP_Y",      "L_HIP_R",      "L_HIP_P",      "L_KNEE_P",     "L_ANKLE_P",    "L_ANKLE_R",
                      "CHEST_P",      "CHEST_Y",      "NECK_Y",       "NECK_P",       "R_SHOULDER_P", "R_SHOULDER_R",
                      "R_SHOULDER_Y", "R_ELBOW_P",    "R_WRIST_Y",    "R_WRIST_P",    "R_WRIST_R",    "R_HAND_J0",
                      "R_HAND_J1",    "L_SHOULDER_P", "L_SHOULDER_R", "L_SHOULDER_Y", "L_ELBOW_P",    "L_WRIST_Y",
                      "L_WRIST_P",    "L_WRIST_R",    "L_HAND_J0",    "L_HAND_J1"};

  _default_attitude = {{1., 0., 0., 0., 0., 0., 0.747187}};
}

std::map<std::string, std::pair<std::string, std::string>> HRP4CommonRobotModule::getConvexHull(
...
void HRP4CommonRobotModule::readUrdf(const std::string & robotName,
                                     bool fixed,
...
std::vector<std::map<std::string, std::vector<double>>> HRP4CommonRobotModule::nominalBounds(
...
std::map<std::string, std::pair<std::string, std::string>> HRP4CommonRobotModule::stdCollisionsFiles(
...
HRP4VREPRobotModule::HRP4VREPRobotModule(bool fixed) : HRP4WithHandRobotModule(fixed)
{
  ...
  _forceSensors[0] =
      mc_rbdyn::ForceSensor("RightFootForceSensor", "r_ankle", sva::PTransformd(Eigen::Vector3d(0., 0., 0.)));
  _forceSensors[1] =
