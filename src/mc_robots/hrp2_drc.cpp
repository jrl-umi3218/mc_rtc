...
: RobotModule(mc_rtc::HRP2_DRC_DESCRIPTION_PATH,
              "hrp2_drc",
              std::string(mc_rtc::HRP2_DRC_DESCRIPTION_PATH) + "/urdf/hrp2drc.urdf")
{
  ...
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("RightFootForceSensor", "RLEG_LINK5", sva::PTransformd(Eigen::Vector3d(0, 0, -0.1050))));
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("LeftFootForceSensor", "LLEG_LINK5", sva::PTransformd(Eigen::Vector3d(0, 0, -0.1050))));
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("RightHandForceSensor", "RARM_LINK6", sva::PTransformd(Eigen::Vector3d(0, 0, -0.087))));
  _forceSensors.push_back(
      mc_rbdyn::ForceSensor("LeftHandForceSensor", "LARM_LINK6", sva::PTransformd(Eigen::Vector3d(0, 0, -0.087))));

  _minimalSelfCollisions = {mc_rbdyn::Collision("LARM_LINK3", "BODY", 0.05, 0.01, 0.),
  ...
  _grippers = {{"l_gripper", {"LARM_JOINT7"}, false}, {"r_gripper", {"RARM_JOINT7"}, false}};

  _ref_joint_order = {"RLEG_JOINT0",  "RLEG_JOINT1",  "RLEG_JOINT2",  "RLEG_JOINT3",  "RLEG_JOINT4",  "RLEG_JOINT5",
                      "LLEG_JOINT0",  "LLEG_JOINT1",  "LLEG_JOINT2",  "LLEG_JOINT3",  "LLEG_JOINT4",  "LLEG_JOINT5",
                      "CHEST_JOINT0", "CHEST_JOINT1", "HEAD_JOINT0",  "HEAD_JOINT1",  "RARM_JOINT0",  "RARM_JOINT1",
                      "RARM_JOINT2",  "RARM_JOINT3",  "RARM_JOINT4",  "RARM_JOINT5",  "RARM_JOINT6",  "RARM_JOINT7",
                      "LARM_JOINT0",  "LARM_JOINT1",  "LARM_JOINT2",  "LARM_JOINT3",  "LARM_JOINT4",  "LARM_JOINT5",
                      "LARM_JOINT6",  "LARM_JOINT7",  "RHAND_JOINT0", "RHAND_JOINT1", "RHAND_JOINT2", "RHAND_JOINT3",
                      "RHAND_JOINT4", "LHAND_JOINT0", "LHAND_JOINT1", "LHAND_JOINT2", "LHAND_JOINT3", "LHAND_JOINT4"};

  _default_attitude = {{1., 0., 0., 0., 0., 0., 0.773}};
}

std::map<std::string, std::pair<std::string, std::string>> HRP2DRCCommonRobotModule::getConvexHull(
...
std::vector<std::map<std::string, std::vector<double>>> HRP2DRCCommonRobotModule::nominalBounds(
...
std::map<std::string, std::pair<std::string, std::string>> HRP2DRCCommonRobotModule::stdCollisionsFiles(
