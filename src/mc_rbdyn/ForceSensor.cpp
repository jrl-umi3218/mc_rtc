  ...
  * from a calibration file. **/
  struct ForceSensorCalibData
  {
    public:
      ...
      ForceSensorCalibData(const std::string & filename,
       ...
       */
      inline sva::ForceVecd wfToSensor(const sva::PTransformd& X_0_p,
...
: ForceSensor("", "", sva::PTransformd::Identity())
{
}
...
void ForceSensor::loadCalibrator(const std::string & calib_file,
                                 const Eigen::Vector3d & gravity)
{
