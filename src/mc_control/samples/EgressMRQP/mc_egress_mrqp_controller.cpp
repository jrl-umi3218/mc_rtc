...
: MCController({robot_module, mc_rbdyn::RobotLoader::get_robot_module("PolarisRangerEgress"),
                mc_rbdyn::RobotLoader::get_robot_module("env",
                                                        std::string(mc_rtc::MC_ENV_DESCRIPTION_PATH),
                                                        std::string("ground"))},
               dt),
  egressContacts(), collsConstraint(robots(), 0, 1, timeStep), curPhase(START), execPhase(new EgressMRStartPhase)
{
  ...
  collsConstraint.addCollisions(solver(), {mc_rbdyn::Collision("RLEG_LINK5", "left_column", 0.1, 0.05, 0.),
  ...
  selfCollisionConstraint.addCollisions(solver(), {mc_rbdyn::Collision("LLEG_LINK3", "LARM_LINK3", 0.05, 0.01, 0.),
  ...
  egressContacts.emplace_back(robots(), robots().robotIndex(), 1, "Butthock", "lazy_seat");
  egressContacts.emplace_back(robots(), robots().robotIndex(), 1, "LFullSole", "exit_platform");
  egressContacts.emplace_back(robots(), robots().robotIndex(), 1, "RightGripper", "bar_wheel");
  ...
  torsoOriTask.reset(new mc_tasks::OrientationTask("CHEST_LINK1", robots(), robots().robotIndex(), 1., 1.));
