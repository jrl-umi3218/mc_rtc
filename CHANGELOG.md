...
- Robots:
  - Convex Hull Generation and Binding for Robot Collision Meshes by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/480
    - Convex hulls are now generated by default from `<collision>` tags containing meshes in the urdf file.
  - Connect Robot Modules by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/462
    - doc: see https://jrl-umi3218.github.io/mc_rtc/tutorials/advanced/new-robot.html#connecting-existing-robot-modules
  - Automatic creation and loading of RobotModule from Visual geometry by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/478
    - doc: see https://jrl-umi3218.github.io/mc_rtc/tutorials/recipes/fsm-example.html#loading-a-robot-from-a-visual-element-geometric-shape
  - Add `OPTIONAL` option to `find_description_package` macro by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/481
- Schemas:
  - JSON Schema LSP Support by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/483
    - `mc_rtc_new[_fsm_]controller` tools now add configuration for `VSCode` and `Neovim` to configure the yaml LSP server to suggest completions and documentation of supported YAML properties.
  - Add support for `Eigen::MatrixXd` by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/486
- Tools:
  - `mc_log_ui`: set minimum widget width by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/476
  - `mc_bin_to_log` : set double precision by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/475
- Doc:
  - Add tutorial about dual arm controller by @chuoru in https://github.com/jrl-umi3218/mc_rtc/pull/499
  - Added `Robogami` to the list of robots by @anastasiabolotnikova in https://github.com/jrl-umi3218/mc_rtc/pull/559
  - Add `Kinova` by @fkanehiro in https://github.com/jrl-umi3218/mc_rtc/pull/496
- Overload task constructors to hide targets and poses in GUI by @Hugo-L3174 in https://github.com/jrl-umi3218/mc_rtc/pull/457
- Configuration: Handle !!str tag to force interpreting scalars as string by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/485
- Add `AsyncJob` helper and threading documentation by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/493
- Make QP run optional in FSM Controllers by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/526
- Replace `boost::filesystem` with `std::filesystem` throughout the codebase by @arntanguy with @Copilot in https://github.com/jrl-umi3218/mc_rtc/pull/546
- compatibility with Ubuntu Resolue and ROS Lyrical by @Kooolkimooov in https://github.com/jrl-umi3218/mc_rtc/pull/538
- Always use system-provided `QHull` by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/521

**Fixes**:

- Make mc-rtc ros-free with [mc-rtc-ros-compat](https://github.com/jrl-umi3218/mc_rtc_ros_compat) by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/565
- fix(odom): set odom as robot pose in world frame by @jrl-robots in https://github.com/jrl-umi3218/mc_rtc/pull/484
- `{fmt}` support with recent versions `8..12`. See https://github.com/arntanguy/fmt-torture-test for a small test repo to investigate `{fmt}` support.
  - fix(fmt): since fmt_10 format is expected to be const by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/528
  - Fix issues with newer version of fmt by @mathieu-celerier in https://github.com/jrl-umi3218/mc_rtc/pull/473
  - Tried to use `eigen-fmt` from Robin Passama. These changes were not kept due to difficulties in managing the breaking changes across multiple fmt versions.
    - Remove eigen-fmt, support for all fmt version (8 through 12) by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/525
    - fix(fmt): Only use eigen-fmt after fmt v9 by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/509
    - Use eigen-fmt by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/506
- Fix schema path preventing task creation from GUI by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/532
- `GNUInstallDirs`: remove hardcoded cmake install path by @khangtpham25 in https://github.com/jrl-umi3218/mc_rtc/pull/535
- Typo in new controller script recommended vscode extensions by @Hugo-L3174 in https://github.com/jrl-umi3218/mc_rtc/pull/533
- Handle collision convexes for multiple convexes per body by @Hugo-L3174 in https://github.com/jrl-umi3218/mc_rtc/pull/539
- Log: fix bin to rosbag conversion by @ThomasDuvinage in https://github.com/jrl-umi3218/mc_rtc/pull/553
- Fix macos build by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/552
...
- Add `MC_RTC_CONTROLLER_CONFIG` env variable to load additional `mc_rtc.yaml` configuration. This is used to let Nix configure paths to runtime dependencies (controller, plugins, etc) without having to install plugins in `mc_rtc`'s install tree as we typically do.
  - feat(config): Load mc_rtc.yaml from MC_RTC_CONTROLLER_CONFIG env variable by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/477
- Misc:
  - Add Nix flake and external jrl-cmakemodules 1.1.0 by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/520
  - Adapt for nixos (fmt 12, boost 1.87, rapidjson 2024-04-09) by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/494
  - Updates for nixpkg by @arntanguy in https://github.com/jrl-umi3218/mc_rtc/pull/495
...
- Ubuntu: 22.04
  - Note: to keep `mc_rtc`'s package ROS-agnostic, it depends by default on `libmc-rtc-ros-compat[-dev]`, that is built without ROS support.
    Thus `mc_rtc` won't resolve `package://` paths from urdf files needed by the convex hull generation (https://github.com/jrl-umi3218/mc_rtc/pull/480).
    If ros is available, you can install `ros-<distro>-mc-rtc-ros-compat` that replaces the library with an ABI compatible one with ROS support. Installing `ros-<distro>-mc-rtc-plugin` has the same effect. Refer to https://github.com/jrl-umi3218/mc_rtc/pull/565 for further details.
- Nix: Linux (all distributions), and macOS
- Superbuild: Ubuntu 22.04

## New Contributors

- @jrl-robots made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/484
- @mathieu-celerier made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/473
- @dependabot[bot] made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/522
- @mc-rtc-nixpkgs-flake-updater[bot] made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/527
- @chuoru made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/499
- @Kooolkimooov made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/538
- @arntanguy with @Copilot made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/546
- @khangtpham25 made their first contribution in https://github.com/jrl-umi3218/mc_rtc/pull/535

**Full Changelog**: https://github.com/jrl-umi3218/mc_rtc/compare/v2.14.0...v2.15.0
