...
src_files=`find include src tests utils -name '*.cpp' -or -name '*.h' -or -name '*.hpp'|grep -Ev "include/mc_rtc/log/serialization/flatbuffers/|include/mc_rtc/log/serialization/dtoa_milo.h|include/mc_rtc/log/serialization/MCLog_generated.h|api.h"`
