...
if(NOT TARGET nanomsg)
  ...
  if(NOT ${nanomsg_FOUND} OR NOT TARGET nanomsg)
    ...
    if(NOT NANOMSG_FOUND)
      message(
        FATAL_ERROR
          "Could not find the nanomsg package using CMake package or pkg-config"
      )
    endif()
    ...
    set_target_properties(
      nanomsg PROPERTIES INTERFACE_LINK_LIBRARIES "${NANOMSG_FULL_LIBRARIES}"
    )
    if(NOT "${NANOMSG_INCLUDE_DIRS}" STREQUAL "")
      set_target_properties(
        nanomsg PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${NANOMSG_INCLUDE_DIRS}"
      )
