...
#
# This module will use GEOS_PREFIX as an hint to find either the geos-config executable
# or the geos library
...
if(NOT TARGET GEOS::geos)
  ...
  if(NOT ${geos_FOUND})
    ...
    find_program(
      GEOS_CONFIG geos-config /usr/local/bin /usr/bin ${GEOS_PREFIX}/bin
    ...
    if(GEOS_CONFIG)
      ...
      if(NOT GEOS_LIBRARY)
        message(
          FATAL_ERROR
            "Found GEOS install prefix (${GEOS_INSTALL_PREFIX}) but no geos library"
        )
      endif()
      ...
      if(GEOS_LIBRARY)
        ...
        message(
          FATAL_ERROR
            "Could not find the geos package, geos-config or the geos library, either you are missing the dependency or you should provide the GEOS_PREFIX hint"
        )
      endif()
    endif()
    add_library(GEOS::geos INTERFACE IMPORTED)
    set_target_properties(
      GEOS::geos PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${GEOS_INSTALL_PREFIX}/include
