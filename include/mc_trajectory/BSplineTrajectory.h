...
public:
  ...
  BSplineTrajectory(const std::vector<Eigen::Vector3d> & controlPoints, const std::vector<Eigen::Vector3d> & derivatives, const std::vector<unsigned> & derivativeIndices, double duration, unsigned int order = 4);
