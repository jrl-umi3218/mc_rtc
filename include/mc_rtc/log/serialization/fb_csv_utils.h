...
struct CSVWriterHelper<mc_rtc::log::LogData_Quaterniond>
{
  ...
  static void write_data(const void * data, std::string & os)
  {
    ...
    os += dtoa_milo(qd->w(), buffer); os += ";";
    os += dtoa_milo(qd->x(), buffer); os += ";";
    os += dtoa_milo(qd->y(), buffer); os += ";";
...
struct CSVWriterHelper<mc_rtc::log::LogData_PTransformd>
{
  ...
  static void write_data(const void * data, std::string & os)
  {
    ...
    auto q = pt->ori();
    auto t = pt->pos();
    os += dtoa_milo(q->w(), buffer); os += ";";
    os += dtoa_milo(q->x(), buffer); os += ";";
    os += dtoa_milo(q->y(), buffer); os += ";";
    os += dtoa_milo(q->z(), buffer); os += ";";
    os += dtoa_milo(t->x(), buffer); os += ";";
    os += dtoa_milo(t->y(), buffer); os += ";";
...
struct CSVWriterHelper<mc_rtc::log::LogData_ForceVecd>
{
  ...
  static void write_data(const void * data, std::string & os)
  {
    ...
    auto f = fv->force();
    auto c = fv->couple();
    os += dtoa_milo(f->x(), buffer); os += ";";
    os += dtoa_milo(f->y(), buffer); os += ";";
    os += dtoa_milo(f->z(), buffer); os += ";";
    os += dtoa_milo(c->x(), buffer); os += ";";
    os += dtoa_milo(c->y(), buffer); os += ";";
...
struct CSVWriterHelper<mc_rtc::log::LogData_MotionVecd>
{
  ...
  static void write_data(const void * data, std::string & os)
  {
    ...
    os += dtoa_milo(a->x(), buffer); os += ";";
    os += dtoa_milo(a->y(), buffer); os += ";";
    os += dtoa_milo(a->z(), buffer); os += ";";
    os += dtoa_milo(l->x(), buffer); os += ";";
    os += dtoa_milo(l->y(), buffer); os += ";";
