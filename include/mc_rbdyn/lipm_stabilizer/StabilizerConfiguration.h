...
{
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  // Whether to add the CoM offset expected from the external wrenches. False if the target CoM generated by the pattern generator already considers the external wrenches, true otherwise.
