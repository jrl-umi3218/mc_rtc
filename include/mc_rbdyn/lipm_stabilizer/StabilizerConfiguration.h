...
struct ExtWrenchConfiguration
{
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  // Whether to add the CoM offset expected from the external wrenches. False if the target CoM generated by the pattern
  /// Should be false if the pattern generator already considers the external wrenches, true otherwise.
 ...
 */
template<>
struct ConfigurationLoader<mc_rbdyn::lipm_stabilizer::ExtWrenchConfiguration>
{
...
struct MC_RBDYN_DLLAPI StabilizerConfiguration
{
  ...
  ExtWrenchConfiguration extWrench; /**< Parameters for the external wrenches */
