...
#ifndef FLATBUFFERS_GENERATED_MCLOG_MC_CONTROL_LOG_H_
#define FLATBUFFERS_GENERATED_MCLOG_MC_CONTROL_LOG_H_
...
inline const mc_control::log::Log *GetLog(const void *buf) {
  return flatbuffers::GetRoot<mc_control::log::Log>(buf);
}

inline bool VerifyLogBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<mc_control::log::Log>(nullptr);
}

inline void FinishLogBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<mc_control::log::Log> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_MCLOG_MC_CONTROL_LOG_H_
