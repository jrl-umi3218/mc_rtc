...
class MC_RBDYN_DLLAPI PositionFunction : public tvm::function::abstract::Function
{
public:
  ...
  inline const Eigen::Vector3d & position() const noexcept { return pos_; }

  /** Set the objective */
  inline void position(const Eigen::Vector3d & pos) noexcept { pos_ = pos; }
  ...
  /** Get the frame */
  inline const mc_rbdyn::RobotFrame & frame() const noexcept { return *robot_frame_; }
