...
- TVM: details::TVMBoundedSpeedConstr
      ...
      .def("addBoundedSpeed",
           nb::overload_cast<QPSolver &, const std::string &, const Eigen::Vector3d &, const Eigen::MatrixXd &,
                             const Eigen::VectorXd &>(&BoundedSpeedConstr::addBoundedSpeed),
           "solver"_a, "bodyName"_a, "bodyPoint"_a, "dof"_a, "speed"_a)
      .def("addBoundedSpeed",
           nb::overload_cast<QPSolver &, const std::string &, const Eigen::Vector3d &, const Eigen::MatrixXd &,
                             const Eigen::VectorXd &, const Eigen::VectorXd &>(&BoundedSpeedConstr::addBoundedSpeed),
           "solver"_a, "bodyName"_a, "bodyPoint"_a, "dof"_a, "lowerSpeed"_a, "upperSpeed"_a)

      .def("addBoundedSpeed",
           nb::overload_cast<QPSolver &, const RobotFrame &, const Eigen::MatrixXd &, const Eigen::VectorXd &>(
               &BoundedSpeedConstr::addBoundedSpeed),
