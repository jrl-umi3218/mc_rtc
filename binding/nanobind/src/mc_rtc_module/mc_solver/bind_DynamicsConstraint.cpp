...
• robot-specific dynamics through motion constraints
      ...
      .def(nb::init<const mc_rbdyn::Robots &, unsigned int, double, bool>(), "robots"_a, "robotIndex"_a, "timeStep"_a,
           "infTorque"_a = false,
           R"(
...
infTorque : bool, optional
    If true, ignore torque limits in the robot model.
      ...
      .def(nb::init<const mc_rbdyn::Robots &, unsigned int, double, const std::array<double, 3> &, double, bool>(),
           "robots"_a, "robotIndex"_a, "timeStep"_a, "damper"_a, "velocityPercent"_a = 1.0, "infTorque"_a = false,
           R"(
...
infTorque : bool
    If true, ignore torque limits in the robot model.
      ...
      .def_prop_ro("robotIndex", &DynamicsConstraint::robotIndex, R"(Index of the robot affected by this constraint.)")

      .def("motionConstr", &DynamicsConstraint::motionConstr,
           R"(
...
This assumes the backend was Tasks.
      ...
      .def("dynamicFunction", &DynamicsConstraint::dynamicFunction,
           R"(
...
This assumes the backend was TVM.
      ...
      .def("addToSolver", &DynamicsConstraint::addToSolverImpl, "solver"_a,
           R"(Add the constraint to the given QPSolver.)")
      .def("removeFromSolver", &DynamicsConstraint::removeFromSolverImpl, "solver"_a,
