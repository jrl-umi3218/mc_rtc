...
class TestMCTasks:
    ...
    def test_posTask(self):
        ...
        posTask3 = mc_tasks.PositionTask(
            "r_wrist", self.robots, 0, weight=500.0, stiffness=2.0
        )
    ...
    def test_oriTask(self):
        ...
        oriTask3 = mc_tasks.OrientationTask(
            "r_wrist", self.robots, 0, weight=500.0, stiffness=2.0
        )
    ...
    def test_vecOriTask(self):
        vecTask1 = mc_tasks.VectorOrientationTask(
            "r_wrist",
            e.Vector3d(0.0, 0.0, 1.0),
            e.Vector3d(1.0, 0.0, 0.0),
            self.robots,
            0,
        )
        vecTask2 = mc_tasks.VectorOrientationTask(
            "r_wrist",
            e.Vector3d(0.0, 0.0, 1.0),
            e.Vector3d(1.0, 0.0, 0.0),
            self.robots,
        ...
        vecTask3 = mc_tasks.VectorOrientationTask(
            "r_wrist",
            e.Vector3d(0.0, 0.0, 1.0),
            e.Vector3d(1.0, 0.0, 0.0),
            self.robots,
    ...
    def test_EFTask(self):
        ...
        efTask3 = mc_tasks.EndEffectorTask(
            "r_wrist", self.robots, 0, weight=1000.0, stiffness=2.0
        )
        ...
        assert (
            efTask1.orientationTask.stiffness() == efTask2.orientationTask.stiffness()
        )
        assert (
            efTask1.orientationTask.stiffness() == efTask3.orientationTask.stiffness()
        )
    ...
    def test_RelEFTask(self):
        ...
        relEfTask2 = mc_tasks.RelativeEndEffectorTask(
            "r_wrist", self.robots, 0, "", 2.0, 1000
        )
        relEfTask3 = mc_tasks.RelativeEndEffectorTask(
            "r_wrist", self.robots, 0, weight=1000.0, stiffness=2.0, relBodyName=""
        )

        assert (
            relEfTask1.positionTask.stiffness() == relEfTask2.positionTask.stiffness()
        )
        assert (
            relEfTask1.positionTask.stiffness() == relEfTask3.positionTask.stiffness()
        )
        ...
        assert (
            relEfTask1.orientationTask.stiffness()
            == relEfTask2.orientationTask.stiffness()
        )
        assert (
            relEfTask1.orientationTask.stiffness()
            == relEfTask3.orientationTask.stiffness()
        )
        assert (
            relEfTask1.orientationTask.weight() == relEfTask2.orientationTask.weight()
        )
        assert (
            relEfTask1.orientationTask.weight() == relEfTask3.orientationTask.weight()
        )

    def test_complianceTask(self):
        compTask1 = mc_tasks.force.ComplianceTask(  # noqa: F841
            self.robots, 0, "R_WRIST_Y_S", 0.005
        )
        compTask2 = mc_tasks.force.ComplianceTask(  # noqa: F841
            self.robots,
            0,
            "R_WRIST_Y_S",
            0.005,
        ...
        compTask3 = mc_tasks.force.ComplianceTask(  # noqa: F841
            self.robots,
            0,
            "R_WRIST_Y_S",
            0.005,
            weight=1000.0,
            stiffness=2.0,
            forceGain=mc_tasks.force.ComplianceTask.defaultFGain,
            torqueThresh=1.0,
            torqueGain=mc_tasks.force.ComplianceTask.defaultTGain,
            forceThresh=3.0,
        )

    def test_surfaceTransformTask(self):
        surfaceTask1 = mc_tasks.SurfaceTransformTask(  # noqa: F841
            "LeftFoot", self.robots, 0
        )
        surfaceTask2 = mc_tasks.SurfaceTransformTask(  # noqa: F841
            "LeftFoot", self.robots, 0, 5.0, 1000.0
        )

    def test_admittanceTask(self):
        admTask1 = mc_tasks.force.AdmittanceTask(  # noqa: F841
            "LeftFoot", self.robots, 0
        )
        admTask2 = mc_tasks.force.AdmittanceTask(  # noqa: F841
            "LeftFoot", self.robots, 0, 5.0, 1000.0
        )
